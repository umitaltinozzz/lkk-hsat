...
Run ID: `20260816Tphase2candidate01Z`  
Completed: 2026-08-16T15:43:44.703257+00:00
...
powershell -ExecutionPolicy Bypass -File .\scripts\run_phase2.ps1 -RunId 20260816Tphase2candidate01Z
```
...
- Generated structural CNFs: 28
- CNFs checked by both locked solvers: 28
- LKK-hybrid/CDCL/ground-truth final mismatches: 0
- Valid structural UNSAT witnesses: 20
- External fallback uses: 8

## Gate behavior

- FastCheapGate: {'RUN_LKK': 28}
- BenefitGate: {'RUN_LKK': 28}
- Structural outcomes: {'UNSAT': 20, 'FEASIBLE': 8}
...
- Recovery statuses: {'COMPLETE': 28}
- Recovery reasons/aborts: {'fixed_point': 28}
